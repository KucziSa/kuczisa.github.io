            ...
            return {
                ...
                init: function (options) {
                   ...
                   // create a point light
                    ...
                    // Set the renderer size to half of the screen resolution
                    const halfScreenWidth = Math.floor(screenWidth / 1.75);
                    const halfScreenHeight = Math.floor(screenHeight / 1.4);

                this.renderer.setSize(halfScreenWidth, halfScreenHeight);
